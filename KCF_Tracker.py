...
class HOG:
    def __init__(self, winsize):
        ...
        self.cell_size = (4, 4)#4*4的cell大小
        self.nbins = 9
        #初始化hog描述子对象
        self.hog = cv2.HOGDescriptor(self.winsize, self.block_size, self.block_stride, self.cell_size, self.nbins)
    ...
    def show_hog(self, hog_feature):
        c, h, w = hog_feature.shape #分别对应 特征维度， 高度， 宽度
...
class Tracker():
    ...
    def get_feature(self, image, roi):
        ...
        if self.gray_feature:
            ...
            feature = feature.reshape(1, self.ph, self.pw)/255 - 0.5 #归一化
        else:
    ...
    def update(self,image):
        ...
        for scale in [1.0]:
            ...
            #print("responses size: ", responses.shape)
...
if __name__ == '__main__':
    ...
    while True:
        ...
        (x, y, w, h) = kcf_tracker.update(frame)
